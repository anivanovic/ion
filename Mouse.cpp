...
void Mouse::setRotation(bool isActive) { m_isRotation = isActive; }

bool Mouse::isRotation() { return m_isRotation && m_buttonDown; }

bool Mouse::isMove() { return m_event.type == SDL_MOUSEMOTION && m_buttonDown; }
...
bool Mouse::isZooming() { return m_event.type == SDL_MOUSEWHEEL; }
